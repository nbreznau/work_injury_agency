...
*data_legal_slavery_country.csv* (Rosling 2020) - adapted, see below
...
no <- c(20,155,344,349,352,366,367,368,371,372,373,616,620,630,640,645,652,660,663,645,679,690,692,694,696,703,760,771,775,780,811,812,817,820,830,835,840,850,920, 200, 205, 210, 211, 212, 220, 221, 223, 225, 230, 235, 255, 290, 305, 310, 316, 317, 325, 338, 339, 345, 350, 355, 359, 360, 365, 369, 370, 375, 380, 385, 390, 395, 666, 698, 700, 702, 704, 705, 710, 712, 731, 732, 740, 750, 770, 800, 817, 940, 950, 983, 986, 987)
...
600 Morocco 1961 Slavery 'abolished' in the constituion Goodman, R. David. 2012. “Demystifying ‘Islamic Slavery’: Using Legal Practices to Reconstruct the End of Slavery in Fes, Morocco.” History in Africa 39: 143–74.
|-
...
```{r savepoint}
# GDP for 
write.csv(wi_df, file = "data/wi_df.csv", row.names = F)
write.csv(wi_df_long, file = "data/wi_df_long.csv", row.names = F)
```
