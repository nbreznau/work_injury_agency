...
#### Communism and Slavery simultaneously
...
To check this logic I also run a model with Communist and slave societies treated as independent entites where slavery societies are kept in the original coding format. 
